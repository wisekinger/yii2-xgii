...
class Module extends \yii\base\Module implements BootstrapInterface
{
     ...
     * @inheritdoc
     */
    public $controllerNamespace = 'yii\xgii\controllers';
    /**
    ...
    public function bootstrap($app)
    {
        if ($app instanceof \yii\web\Application) {
            ...
            $app->controllerMap[$this->id] = [
                'class' => 'yii\xgii\console\GenerateController',
    ...
    {
        return [
            'model' => ['class' => 'yii\xgii\generators\model\Generator'],
            'xmodel' => ['class' => 'yii\xgii\generators\xmodel\Generator'],
            'crud' => ['class' => 'yii\xgii\generators\crud\Generator'],
            'controller' => ['class' => 'yii\xgii\generators\controller\Generator'],
            'form' => ['class' => 'yii\xgii\generators\form\Generator'],
            'module' => ['class' => 'yii\xgii\generators\module\Generator'],
            'extension' => ['class' => 'yii\xgii\generators\extension\Generator'],
        ];
    }
